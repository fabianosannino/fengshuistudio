...
export async function GET(request: Request) {
  const { success, indisponivel: limiteIndisponivel } = await rateLimit(ipDaRequisicao(request), { limit: 20, windowMs: 60_000, escopo: 'GET:/api/pedidos/arquivo', exigirCompartilhado: true })
