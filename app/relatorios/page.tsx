 ...
 *
 * Esta era a `/dashboard`. Os quatro gráficos e os contadores continuam
 * valendo — mas como **relatório**, que é o que eles são: uma leitura mensal
 * do negócio, consultada de vez em quando. Ocupando a home, eles respondiam
 * uma pergunta que ninguém faz ao abrir o app. A home passou a responder «o
 * que eu preciso fazer agora?» (ver `app/dashboard/page.tsx`).
 */
    ...
    <AppShell currentPage="relatorios">
      ...
      <div style={{ marginBottom: '32px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '16px', flexWrap: 'wrap' }}>
        <div>
          ...
          <h1 style={{ color: '#0E1B2C', fontSize: '30px', fontWeight: 600, margin: '0 0 6px 0', letterSpacing: '-0.01em', fontFamily: 'var(--font-fraunces), serif' }}>
            Números do seu negócio
          </h1>
          <p style={{ color: '#6B7280', fontSize: '15px', margin: '0' }}>
            Consultas, clientes e pagamentos ao longo do tempo
          </p>
        </div>
