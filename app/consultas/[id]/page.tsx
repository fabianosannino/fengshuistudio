    ...
    <FlowLayout showHeader backLabel="Consultas" backHref="/consultas">
      ...
      <main style={{ padding: '24px 32px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{margin:'0 0 18px',padding:14,border:'1px solid #CFE6E0',borderRadius:8,background:'#F4F8F6'}}>
          ...
          <button type="button" onClick={()=>router.push(`/consultas/${id}/analises`)} style={{minHeight:44,padding:'8px 14px',border:'1px solid #245F52',borderRadius:6,color:'#245F52',background:'#fff'}}>Histórico de análises por método</button>
        </div>
        {/* ── Tab Navigation ───────────────────────────────────────────────── */}
        <div style={{
