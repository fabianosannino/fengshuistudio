          ...
          <div style={{ background: '#ffffff', borderRadius: '12px', padding: '32px', boxShadow: '0 1px 4px rgba(0,0,0,0.08)' }}>
            <form onSubmit={handleStep1}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '20px' }}>
                <div>
                  <label style={{ display: 'block', color: '#374151', fontSize: '14px', fontWeight: 'bold', marginBottom: '6px' }}>Nome do imovel</label>
                  <input name="nome_imovel" value={form.nome_imovel} onChange={handleChange} placeholder="Ex: Apartamento Centro"
              ...
              <div style={{ display: 'flex', gap: '12px' }}>
                ...
                <button type="submit" disabled={saving || clientes.length === 0} style={{
          ...
          <div style={{ background: '#ffffff', borderRadius: '12px', padding: '32px', boxShadow: '0 1px 4px rgba(0,0,0,0.08)' }}>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <button onClick={handleStep2} disabled={saving || setoresAtivos.length === 0} style={{
                ...
                color: '#ffffff', border: 'none', borderRadius: '8px',
                fontSize: '15px', fontWeight: 'bold', cursor: saving ? 'not-allowed' : 'pointer'
              }}>{saving ? 'Salvando...' : 'Criar consulta ✓'}</button>
            </div>
          </div>
        )}
      </div>
