...
| 1.7 Tai Ji / centróide / regra do terço | 🟡 Matemática do centróide geométrico real implementada e testada (`src/lib/poligono.ts`, ver ADR 0009), mas ainda não conectada à UI — a captura da planta hoje é um retângulo, não um polígono arbitrário. Regra do terço não implementada (ambiguidade real, ver ADR 0009) |
