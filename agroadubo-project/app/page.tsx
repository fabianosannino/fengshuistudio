...
export default function LandingPage() {
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', color: '#1a1a2e', overflowX: 'hidden' }}>
      <style>{`
        ...
        .btn-hero { background: linear-gradient(135deg, #16a34a, #15803d); color: #fff; border: none; padding: 18px 44px; border-radius: 14px; font-size: 17px; font-weight: 700; cursor: pointer; transition: all 0.3s ease; font-family: Arial, sans-serif; }
        .btn-hero:hover { transform: translateY(-2px); box-shadow: 0 12px 40px rgba(22,163,74,0.4); }
        .btn-outline { background: transparent; color: #fff; border: 2px solid rgba(255,255,255,0.4); padding: 16px 36px; border-radius: 14px; font-size: 16px; font-weight: 600; cursor: pointer; transition: all 0.3s ease; font-family: Arial, sans-serif; text-decoration: none; }
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 32px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <button onClick={() => window.location.href = '/avaliar'} style={{
          ...
          <div className="hero-grid" style={{ display: 'flex', alignItems: 'center', gap: '60px' }}>
            <div style={{ flex: 1 }}>
              <div className="fade-up" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(34,197,94,0.15)', border: '1px solid rgba(34,197,94,0.3)', borderRadius: '100px', padding: '8px 20px', marginBottom: '24px' }}>
                ...
                <span style={{ color: '#86efac', fontSize: '13px', fontWeight: 600, letterSpacing: '0.05em' }}>TECNOLOGIA PARA O AGRO</span>
              </div>
              ...
              <p className="fade-up fade-up-d2" style={{ color: 'rgba(255,255,255,0.7)', fontSize: '18px', lineHeight: 1.7, marginBottom: '40px', maxWidth: '520px' }}>
                Tire uma foto, informe sua regiao e tipo de producao. Receba instantaneamente a recomendacao completa de adubos e tubetes de polpa moldada personalizados para sua planta.
              </p>
            ...
            <div className="hide-mobile" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <div className="fade-up fade-up-d3" style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', width: '280px' }}>
                  {[
                    { icon: '\uD83D\uDCF7', label: 'Foto da planta', color: '#4ade80' },
      ...
      {/* RECURSOS */}
      <section id="recursos" style={{ background: '#f0fdf4', padding: '100px 32px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div className="features-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }}>
            {[
              { icon: '\uD83D\uDCF7', title: 'Identificacao por Foto', desc: 'Tire uma foto da planta e o sistema ajuda a identificar a especie para recomendacao precisa.', color: '#16a34a' },
              ...
              { icon: '\uD83D\uDCF1', title: 'Funciona no Celular', desc: 'Interface otimizada para uso no campo. Funciona offline apos carregar, ideal para areas rurais.', color: '#0891b2' },
            ].map((feat, i) => (
              <div key={i} className="feature-card" style={{ background: '#ffffff', borderRadius: '20px', padding: '32px', border: '1px solid #e5e7eb' }}>
      ...
      <section id="como-funciona" style={{ background: '#ffffff', padding: '100px 32px' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          <div className="steps-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '20px', position: 'relative' }}>
            ...
            {[
              { step: '1', title: 'Tire a foto', desc: 'Fotografe a planta pelo celular', color: '#16a34a', icon: '\uD83D\uDCF7' },
              { step: '2', title: 'Regiao', desc: 'GPS automatico ou selecao manual', color: '#2563eb', icon: '\uD83D\uDCCD' },
      ...
      {/* TUBETES */}
      <section id="tubetes" style={{ background: 'linear-gradient(165deg, #052e16, #14532d)', padding: '100px 32px', position: 'relative' }}>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px' }}>
            {[
              ...
              <div key={i} style={{
                background: 'rgba(255,255,255,0.05)', border: `1px solid ${t.cor}40`,
                borderRadius: '20px', padding: '28px',
              }}>
                <div style={{ fontSize: '36px', marginBottom: '12px' }}>{'\uD83C\uDF31'}</div>
                <p style={{ color: t.cor, fontSize: '24px', fontWeight: 800, margin: '0 0 4px 0' }}>{t.tamanho}</p>
                <p style={{ color: '#ffffff', fontSize: '15px', fontWeight: 600, margin: '0 0 12px 0' }}>{t.para}</p>
                <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '13px', margin: '0 0 16px 0', lineHeight: 1.6 }}>{t.plantas}</p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  {['Substrato personalizado', 'Adubo de liberacao lenta', 'Biodegradavel no solo'].map((item, j) => (
                    <div key={j} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <span style={{ color: t.cor, fontSize: '12px' }}>{'\u2713'}</span>
